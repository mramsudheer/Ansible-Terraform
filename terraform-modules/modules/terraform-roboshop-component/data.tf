...
data "aws_ssm_parameter" "private_subnet_ids" {
  name = "/${title(var.project_name)}/${title(var.environment)}/vpc/private-subnet-ids"
}
...
data "aws_ssm_parameter" "backend_alb_listener_arn" {
  name = "/${title(var.project_name)}/${title(var.environment)}/alb/backend_listener_arn_listener_arn"
}

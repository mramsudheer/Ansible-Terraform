...
resource "terraform_data" "main" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "sudo sh /tmp/bootstrap.sh ${var.component} ${lower(var.environment)} ${var.app_version}"
    ]
  }
}
...
resource "aws_ami_from_instance" "main" {
  name               = "${var.project_name}-${var.environment}-${var.component}-${var.app_version}"
...
# if frontend frontend-dev.intellifind.store
